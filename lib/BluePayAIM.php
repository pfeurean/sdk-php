 ...
 * @subpackage AuthorizeNetAIM
 */
class BluePayAIM extends AuthorizeNetRequest
{

    const LIVE_URL = 'https://secure.bluepay.com/interfaces/a.net';
    const SANDBOX_URL = 'https://secure.bluepay.com/interfaces/a.net.test';
     ...
     * 
     * @return BluePayAIM_Response
     */
    protected function _handleResponse($response)
    {
        return new BluePayAIM_Response($response, $this->_x_post_fields['delim_char'], $this->_x_post_fields['encap_char'], $this->_custom_fields);
    }
 ...
 * @subpackage AuthorizeNetAIM
 */
class BluePayAIM_Response extends AuthorizeNetResponse
{
    ...
    public function __construct($response, $delimiter, $encap_char, $custom_fields)
    {
        if ($response) {
            ...
            //BLUEPAY AINT RETURNING THESE!
            if (count($this->_response_array) > 49) {
